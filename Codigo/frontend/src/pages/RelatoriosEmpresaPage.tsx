...
export function RelatoriosEmpresaPage() {
  ...
  if (usuario.tipo !== 'EMPRESA') return <Navigate to="/dashboard/empresa" replace />;
      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-sm mt-1">Análise de resgates e desempenho das vantagens</p>
          </div>
